...
<xml>
        ...
        <block type="colour_blend">
            <value name="COLOUR1">
                <shadow type="colour_picker">
                    <field name="COLOUR">#A0A0A0</field>
                </shadow>
            </value>
            <value name="COLOUR2">
                <shadow type="colour_picker">
                    <field name="COLOUR">#0A0A0A</field>
                </shadow>
            </value>
            <value name="RATIO">
                <shadow type="math_number">
    ...
    <category name="Rasa" colour="#663399">
        <block type="rasa_send">
            <value name="content">
                <block type="text">
    ...
    <category name="Advanced" colour="#000000">
        <block type="advanced_codeArea">
        </block>
    </category>
    <sep></sep>
